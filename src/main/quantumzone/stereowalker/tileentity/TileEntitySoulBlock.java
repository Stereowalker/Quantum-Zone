 ...
 * @author Choonster
 */
public class TileEntitySoulBlock extends TileEntity implements ITickable {
	...
	public void update() {
		if (!getWorld().isRemote) {
			...
			entities.stream().filter(entity -> !entity.isPotionActive(MobEffects.WITHER)).forEach(entity -> entity.addPotionEffect(new PotionEffect(MobEffects.WITHER, 200, 1)));
		}
	}
}
