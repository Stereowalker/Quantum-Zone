package quantumzone.stereowalker.container;
...
import quantumzone.stereowalker.container.slots.SlotEnchantedBook;
...
public class ContainerMiner extends Container {
	 ...
	 */
	public ContainerMiner(IInventory playerInv, TileEntityMiner te) {
		this.te = te;
        ...
        //this.addSlotToContainer(new SlotFurnaceFuel(playerInv, 10, 134, 53));
