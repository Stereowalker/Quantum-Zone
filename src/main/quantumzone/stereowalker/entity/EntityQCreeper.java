...
import quantumzone.stereowalker.entity.ai.EntityAIQCreeperSwell;
import quantumzone.stereowalker.util.LootTable;

public class EntityQCreeper extends EntityMob
{
    ...
    public EntityQCreeper(World worldIn)
    {
        super(worldIn);
    ...
    protected void initEntityAI()
    {
        ...
        this.tasks.addTask(2, new EntityAIQCreeperSwell(this));
    ...
    public void onDeath(DamageSource cause)
    {
        ...
        if (this.world.getGameRules().getBoolean("doMobLoot"))
        {
            ...
            else if (cause.getTrueSource() instanceof EntityQCreeper && cause.getTrueSource() != this && ((EntityQCreeper)cause.getTrueSource()).getPowered() && ((EntityQCreeper)cause.getTrueSource()).isAIEnabled())
            {
                ((EntityQCreeper)cause.getTrueSource()).incrementDroppedSkulls();
    ...
    private void spawnLingeringCloud()
    {
        ...
        if (!collection.isEmpty())
        {
            ...
            entityareaeffectcloud.setRadiusOnUse(-1.0F);
            entityareaeffectcloud.setWaitTime(100);
