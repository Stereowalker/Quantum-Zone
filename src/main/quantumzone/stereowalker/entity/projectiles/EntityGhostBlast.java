...
public abstract class EntityGhostBlast extends Entity
{
    ...
    public EntityGhostBlast(World worldIn)
    {
        super(worldIn);
    ...
    public EntityGhostBlast(World worldIn, double x, double y, double z, double accelX, double accelY, double accelZ)
    {
        super(worldIn);
        this.setSize(1.0F, 1.0F);
    ...
    public EntityGhostBlast(World worldIn, EntityLivingBase shooter, double accelX, double accelY, double accelZ)
    {
        super(worldIn);
