...
import quantumzone.stereowalker.entity.ai.EntityAIQZombieAttack;
...
//EntityZombie
public class EntityQZombie extends EntityMob
{
    ...
    private static final DataParameter<Boolean> IS_CHILD = EntityDataManager.<Boolean>createKey(EntityQZombie.class, DataSerializers.BOOLEAN);
    /**
     * Was the type of villager for zombie villagers prior to 1.11. Now unused. Use {@link
     * EntityZombieVillager#PROFESSION} instead.
     */
    private static final DataParameter<Integer> VILLAGER_TYPE = EntityDataManager.<Integer>createKey(EntityQZombie.class, DataSerializers.VARINT);
    private static final DataParameter<Boolean> ARMS_RAISED = EntityDataManager.<Boolean>createKey(EntityQZombie.class, DataSerializers.BOOLEAN);
    ...
    public EntityQZombie(World worldIn)
    {
        super(worldIn);
    ...
    protected void initEntityAI()
    {
        ...
        this.tasks.addTask(2, new EntityAIQZombieAttack(this, 1.0D, false));
    ...
    protected void applyEntityAttributes()
    {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.MOVEMENT_SPEED).setBaseValue(0.46000000834465026D);
    ...
    public boolean attackEntityFrom(DamageSource source, float amount)
    {
        if (super.attackEntityFrom(source, amount))
        {
            ...
            SummonAidEvent summonAid = quantumzone.stereowalker.event.QuantumEventFactory.fireZombieSummonAid(this, world, i, j, k, entitylivingbase, this.getEntityAttribute(SPAWN_REINFORCEMENTS_CHANCE).getAttributeValue());
                ...
                entitylivingbase != null && this.world.getDifficulty() == EnumDifficulty.HARD && (double)this.rand.nextFloat() < this.getEntityAttribute(SPAWN_REINFORCEMENTS_CHANCE).getAttributeValue() && this.world.getGameRules().getBoolean("doMobSpawning"))
            {
                ...
                {
                    entityzombie = new EntityQZombie(this.world);
                }
    ...
    {
        EntityLiving.registerFixesMob(fixer, EntityQZombie.class);
    }
    ...
    public void onKillEntity(EntityLivingBase entityLivingIn)
    {
        ...
        if ((this.world.getDifficulty() == EnumDifficulty.NORMAL || this.world.getDifficulty() == EnumDifficulty.HARD) && entityLivingIn instanceof EntityVillager)
        {
            ...
            entityzombievillager.onInitialSpawn(this.world.getDifficultyForLocation(new BlockPos(entityzombievillager)), new EntityQZombie.GroupData(false));
        ...
        if (entityLivingIn instanceof EntityZombie)
        {
            ...
            entityqzombie.setHeldItem(entityzombie.getActiveHand(), new ItemStack(Itm.LIGHTERAD));
    ...
    public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, @Nullable IEntityLivingData livingdata)
    {
        ...
        if (livingdata == null)
        {
            livingdata = new EntityQZombie.GroupData(this.world.rand.nextFloat() < net.minecraftforge.common.ForgeModContainer.zombieBabyChance);
        }

        if (livingdata instanceof EntityQZombie.GroupData)
        {
            EntityQZombie.GroupData entityzombie$groupdata = (EntityQZombie.GroupData)livingdata;
