...
public class RenderGhostBlast extends Render<EntityGhostBlast>//RenderSmallFireball
{
    private final float scale;

    public RenderGhostBlast(RenderManager manager, float scaleIn)
    {
        super(manager);
        this.scale = scaleIn;
    }
     ...
     */
    public void doRender(EntityGhostBlast entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityGhostBlast entity)
    {
