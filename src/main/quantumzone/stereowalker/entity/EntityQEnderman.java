...
import quantumzone.stereowalker.entity.EntityQEnderman.AIFindPlayer;
import quantumzone.stereowalker.util.LootTable;

public class EntityQEnderman extends EntityMob
{
    ...
    public EntityQEnderman(World worldIn)
    {
        super(worldIn);
    ...
    protected void initEntityAI()
    {
        ...
        this.tasks.addTask(10, new EntityQEnderman.AIPlaceBlock(this));
        this.tasks.addTask(11, new EntityQEnderman.AITakeBlock(this));
        this.targetTasks.addTask(1, new EntityQEnderman.AIFindPlayer(this));
    ...
    static class AIFindPlayer extends EntityAINearestAttackableTarget<EntityPlayer>
        {
            private final EntityQEnderman enderman;
            /** The player */
            private EntityPlayer player;
            private int aggroTime;
            private int teleportTime;

            public AIFindPlayer(EntityQEnderman entityQEnderman)
            {
                super(entityQEnderman, EntityPlayer.class, false);
                this.enderman = entityQEnderman;
            }
    ...
    static class AIPlaceBlock extends EntityAIBase
        {
            ...
            public AIPlaceBlock(EntityQEnderman entityQEnderman)
            {
                this.enderman = entityQEnderman;
            }
    ...
    static class AITakeBlock extends EntityAIBase
        {
            ...
            public AITakeBlock(EntityQEnderman entityQEnderman)
            {
                this.enderman = entityQEnderman;
            }
            ...
            public void updateTask()
            {
                ...
                if (EntityQEnderman.CARRIABLE_BLOCKS.contains(block) && flag)
                {
    ...
    public void onKillEntity(EntityLivingBase entityLivingIn) {
		...
		if (entityLivingIn instanceof EntityEnderman)
        {
