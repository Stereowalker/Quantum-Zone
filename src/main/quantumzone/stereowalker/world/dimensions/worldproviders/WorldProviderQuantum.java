package quantumzone.stereowalker.world.dimensions.worldproviders;
...
import quantumzone.stereowalker.world.dimensions.ChunkGeneratorQuantum;
import quantumzone.stereowalker.world.dimensions.DimensionsManager;

public class WorldProviderQuantum extends WorldProvider{
	
	public void init()
    {
        this.biomeProvider = new BiomeProviderSingle(Bio.QUANTUMZONE);
    }

    public IChunkGenerator createChunkGenerator()
    {
        return new ChunkGeneratorQuantum(this.world, this.world.getWorldInfo().isMapFeaturesEnabled(), this.world.getSeed());
    }
	...
	public DimensionType getDimensionType() {
		return DimensionsManager.QUANTUM;
	}
