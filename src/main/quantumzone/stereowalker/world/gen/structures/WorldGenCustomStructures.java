...
import quantumzone.stereowalker.world.gen.WorldGenStructure;
...
public class WorldGenCustomStructures implements IWorldGenerator{
	...
	public void generate(Random random, int chunkX, int chunkZ, World world, IChunkGenerator chunkGenerator, IChunkProvider chunkProvider) {
		...
		case 1:
			break;
		case 0:
			spawnStructure(CASTLE, world, random, chunkX, chunkZ, 1000, Blk.BLOCK_QUANTEX_SOIL, BiomeQuantumForest.class);
			break;
		case -1:
			break;
		}
	...
	private void spawnStructure(WorldGenerator generator, World world, Random rand, int chunkX, int chunkZ, int chance, Block topBlock, Class<?>...classes ) {
