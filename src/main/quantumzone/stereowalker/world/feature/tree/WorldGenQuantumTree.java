...
public class WorldGenQuantumTree extends WorldGenAbstractTree
{
    private static final IBlockState TRUNK = Blk.LOGS.getDefaultState().withProperty(BlockLogs.VARIANT, TreeHandler.EnumType.QUANTUM);
    private static final IBlockState LEAF = Blk.LEAVES.getDefaultState().withProperty(BlockLeaf.VARIANT, TreeHandler.EnumType.QUANTUM).withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));

    public WorldGenQuantumTree()
    {
        super(false);
    }
