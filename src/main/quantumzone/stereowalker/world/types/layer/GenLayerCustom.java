package quantumzone.stereowalker.world.types.layer;
...
public class GenLayerCustom extends GenLayer
{
    ...
    public GenLayerCustom(long p_i45560_1_, GenLayer p_i45560_3_, WorldType p_i45560_4_, ChunkGeneratorSettings p_i45560_5_)
    {
        ...
        biomes[desertIdx].add(new net.minecraftforge.common.BiomeManager.BiomeEntry(Bio.COLDDESERT, 40));
        biomes[desertIdx].add(new net.minecraftforge.common.BiomeManager.BiomeEntry(Bio.QUANTUM, 40));
        biomes[desertIdx].add(new net.minecraftforge.common.BiomeManager.BiomeEntry(Bio.QUANTUMFOREST, 40));
        biomes[desertIdx].add(new net.minecraftforge.common.BiomeManager.BiomeEntry(Bio.TROPICALFOREST, 40));

        if (p_i45560_4_ == WorldType.DEFAULT_1_1)
        {
            biomes[desertIdx].clear();
            biomes[desertIdx].add(new net.minecraftforge.common.BiomeManager.BiomeEntry(Bio.COLDDESERT, 15));
            biomes[desertIdx].add(new net.minecraftforge.common.BiomeManager.BiomeEntry(Bio.QUANTUM, 15));
            biomes[desertIdx].add(new net.minecraftforge.common.BiomeManager.BiomeEntry(Bio.QUANTUMFOREST, 15));
            biomes[desertIdx].add(new net.minecraftforge.common.BiomeManager.BiomeEntry(Bio.TROPICALFOREST, 15));
            this.settings = null;
        }
        else
        {
